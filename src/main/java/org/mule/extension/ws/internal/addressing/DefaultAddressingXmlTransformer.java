...
public class DefaultAddressingXmlTransformer implements AddressingXmlTransformer {
  ...
  public DefaultAddressingXmlTransformer(MuleExpressionLanguage expressionExecutor) {
    this.expressionExecutor = expressionExecutor;
  }

  @Override
  public String transformToXml(EndpointReferenceType endpoint, QName qname, boolean mustUnderstand) {
  ...
  @Override
  public String transformToXml(URIType uri, QName qname, boolean mustUnderstand) {
    return transformToXml(uri.getValue(), qname, mustUnderstand);
  }

  @Override
  public String transformToXml(RelatesToType relatesTo, QName qname, boolean mustUnderstand) {
    if (!relatesTo.getRelationShip().isPresent()) {
      return transformToXml(relatesTo.getValue(), qname, mustUnderstand);
    }
  ...
  public String transformToXml(String value, QName qname, boolean mustUnderstand) {
    BindingContext context = getDefaultBindingContext(qname, mustUnderstand)
